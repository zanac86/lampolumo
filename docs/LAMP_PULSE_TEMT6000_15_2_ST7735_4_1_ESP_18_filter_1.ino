...
void loop() {
  ...
  if (micros() > (timer_2 + 312.5))
  {
    ...
    if (x < 160)
    {
      ...
      if (x > 0) mid_point_arr[x] = (point_arr[x-1] + point_arr[x])/2;
      x++;
    } else {
      arr_filled = true;
      x = 0;
...
//      }
    ...
    */
    ...
    for (int x2 = 0; x2 <128; x2++)
    {
      ...
      if (x2 > 1) y_1_1 = 40 - int( ((mid_point_arr[x2 + x1_min - 1] - y_min)/ (delta_y / 40.0) ) ); //int(mid_point_arr[x2 + x1_min - 1]/17.07);
      y_1_2 = 40 - int( ((mid_point_arr[x2 + x1_min] - y_min)/ (delta_y / 40.0) ) );

      if (y_1_1 < 0) y_1_1 = 0;
      if (y_1_1 > 40) y_1_1 = 40;

      if (y_1_2 < 0) y_1_2 = 0;
      if (y_1_2 > 40) y_1_2 = 40;
      
      if (y_1 < 0) y_1 = 0;
      if (y_1 > 40) y_1 = 40;
      if (x2 > 1) tft.drawLine(x2-1, y_1_1, x2-1, y_1_2, ST7735_WHITE);
      ...
      if (y_2_1 < 100) y_2_1 = 100;
      if (y_2_1 > 159) y_2_1 = 159;

      if (y_2_2 < 100) y_2_2 = 100;
      if (y_2_2 > 159) y_2_2 = 159;
      
      if (y_2 < 100) y_2 = 100;
      if (y_2 > 159) y_2 = 159;
      tft.drawLine(x2, 159, x2, 100, ST7735_BLACK); //ST77XX_YELLOW
      if (x2 > 1) tft.drawLine(x2-1, y_2_1, x2-1, y_2_2, ST7735_WHITE);
